...
var Twitter = {
  ...
  oauth: {
    ...
    service: function(screen_name) {
      ...
      .setConsumerKey(PropertiesService.getScriptProperties().getProperty("twitterConsumerKey"))
      .setConsumerSecret(PropertiesService.getScriptProperties().getProperty("twitterConsumerSecret"))
